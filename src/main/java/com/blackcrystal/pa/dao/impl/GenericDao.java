package com.blackcrystal.pa.dao.impl;
...
import com.blackcrystal.pa.dao.Dao;
import com.blackcrystal.pa.dao.enums.BoolEnum;
import com.blackcrystal.pa.dao.po.PersistentObject;
import com.blackcrystal.pa.dao.po.SimplePersistentObject;
import com.blackcrystal.pa.utils.DateTimeUtils;
...
public abstract class GenericDao<T extends PersistentObject> extends
	...
	private void beforeSave(T entity) {
		...
		if (entity instanceof SimplePersistentObject) {
			//
			SimplePersistentObject spo = (SimplePersistentObject) entity;
			final Date now = DateTimeUtils.currentTime();
			spo.setInputDate(now);
			spo.setUpdateDate(now);
			spo.setActiveFlag(BoolEnum.active());
		}
