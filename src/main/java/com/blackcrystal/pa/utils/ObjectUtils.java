...
/**
 * 
 * @see com.ematchina.test.common.utils.ObjectUtilsTest
 * @author Jingqi Xu
 */
...
public abstract class ObjectUtils {
	...
	public static boolean isCloneable(Object obj) {
		...
		//
		Method method = ReflectionUtils.findPublicMethod(clazz, "clone",
				new Class<?>[] {});
		return method != null;
	}
	...
	public static Object getDefaultValue(Class<?> clazz) {
		...
		throw new RuntimeException(
				"assertion failed, should not reach here, clazz: " + clazz);
	}
	...
	public static Object arrayCopy(Object array) {
		...
		if (!isArray(array)) {
			throw new IllegalArgumentException(
					"parameter array is not an Array");
		}

		//
		final int length = Array.getLength(array);
		final Object r = Array.newInstance(array.getClass().getComponentType(),
				length);
	...
	public static Object cloneCopy(Object obj) {
		...
		if (!isCloneable(obj)) {
			throw new IllegalArgumentException("parameter obj: " + obj
					+ " is not cloneable");
		}
	...
	public static void copy(Object src, Object dst) {
		...
		if (!src.getClass().equals(dst.getClass())) {
			throw new IllegalArgumentException(
					"the class does not match, src: " + src.getClass()
							+ ", dst: " + dst.getClass());
		}
