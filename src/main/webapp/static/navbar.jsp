			...
			<ul class="nav ace-nav">
				...
				<li class="green"><a data-toggle="dropdown"
					...
					<ul
						...
						<li><a href="#"> <img
								src="${ctx}/static/assets/avatars/avatar.png" class="msg-photo"
						...
						<li><a href="#"> <img
								src="${ctx}/static/assets/avatars/avatar3.png" class="msg-photo"
						...
						<li><a href="#"> <img
								src="${ctx}/static/assets/avatars/avatar4.png" class="msg-photo"
				...
				<li class="light-blue"><a data-toggle="dropdown" href="#"
					class="dropdown-toggle"> <img class="nav-user-photo"
						src="${ctx}/static/assets/avatars/user.jpg" alt="Jason's Photo" />
